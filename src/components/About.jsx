			...
			<div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-ful h-full">
				...
				>
					<p className="text-xl mt-10">
						I am Samkit Samsukha, a passionate{" "}
						<span
							className={`${
						...
						. I am currently stationed at Bengaluru and looking for web
						development projects and activities. I have been working on the{" "}
						<span
							className={`${
								mode === "dark" ? "text-blue-300" : "text-blue-800"
							} font-semibold`}
						...
						and am flexible enough to try out the other dev tools in order to
						develop skills.
					</p>
				</motion.div>
				<br />
						...
						<div
							...
							className={`${
								mode === "dark"
									...
									: "bg-gradient-to-br from-gray-400 to-gray-400 via-gray-300"
							} p-2 h-full w-full md:w-1/3 rounded-lg`}
						>
							...
							<h1
								className={`text-xl ${
									mode === "dark" ? "text-blue-200" : "text-slate-900"
								} mb-1 font-semibold text-center`}
							>
								{data.institution}
							</h1>
							<p
